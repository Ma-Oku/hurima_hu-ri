...
class Controller extends BaseController
{
    ...
    public function respondNotVerify($api_code) {
        return $this->respondWithError($api_code, 405);
    }
    public function respondNotOrder($api_code) {
        return $this->respondWithError($api_code, 406);
    }
}
